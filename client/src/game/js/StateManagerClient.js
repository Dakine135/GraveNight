...
module.exports = class StatesManager {
    constructor({ debug = false, debugState = false, stateInterpolation = true, clientSimulation = true, engine = null }) {
	...
	*/
    reciveServerState(data) {
        ...
        if (this.timeSinceLastServerUpdate > 0) {
            this.serverUpdatesPerSecond = (1000 / this.timeSinceLastServerUpdate) * 0.8 + this.serverUpdatesPerSecond * 0.2;
    ...
    getPlayersInRange({ x = 0, y = 0, distance = 50 }) {
