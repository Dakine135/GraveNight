module.exports = class HUD {
    constructor({ debug = false, fontSize = 20, engine = null, canvas = null }) {
        this.ENGINE = engine;
    ...
    draw() {
        ...
        if (this.ENGINE.CONTROLS.rightClickPressed) {
            this.render.beginPath();
            this.render.arc(this.ENGINE.CONTROLS.mouse.x, this.ENGINE.CONTROLS.mouse.y, size * 2, 0, Math.PI * 2);
            this.render.stroke();
        }
        ...
        this.render.fillText(
            ...
            this.ENGINE.CONTROLS.mouse.y - size
        );
        //location in world
        let mouseWorld = this.ENGINE.CONTROLS.translateScreenLocToWorld(this.ENGINE.CONTROLS.mouse.x, this.ENGINE.CONTROLS.mouse.y);
        this.render.fillText(mouseWorld.x + ',' + mouseWorld.y, this.ENGINE.CONTROLS.mouse.x, this.ENGINE.CONTROLS.mouse.y + size * 2);
        this.render.restore();
    } //draw
}; //HUD
